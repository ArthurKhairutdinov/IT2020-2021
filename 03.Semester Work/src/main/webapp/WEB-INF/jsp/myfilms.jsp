<%@ page import="ru.itis.models.UsersFilm" %>
...
<div class="vw-auto vh-100 bg-light py-2">
    <div class="pg-inline mx-3 mt-3 my-lg-0 p-3 bg-white border" style="border-radius:20px">
      ...
      <form action="/myfilms" method="post">
              <div class="form-group">
                  <div class="row justify-content-center pb-2">
                      <div class="col-md-auto">

                          <input type="text" class="form-control" name="name_input" placeholder="Name">
        ...
        <table class="table">
            ...
            <tbody>
            <%
            List<UsersFilm> films = (List<UsersFilm>) request.getAttribute("userfilmsForJsp");
